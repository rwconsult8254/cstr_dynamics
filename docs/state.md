...
- **Phase 1 deliverables (gate: all four written and signed off, no code):**
  1. Derivation — mole balance, reactor and jacket energy balances, Arrhenius
     kinetics, cascade loop structure. Roger writes; agent checks against RAG.
  2. Parameter set with the argument for each number.
...
- **Next:** Roger reviews the four Drive docs; then derive the parameter set
  ...
  reachable by loss of cooling; size UA and coolant flow for the cooling
  margin. Check against Perry's ch. 19 stability criterion. Reuse strategy
  (decision 1) is due before Phase 2.
- **Phase 1 start / week-four review / end:** 2026-09-23 / 2026-10-21 /
  2026-11-18.
- **Blockers:** none.
